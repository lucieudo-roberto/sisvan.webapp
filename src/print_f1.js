...
window.onload = function(){
    ...
    for (let x=0; x<rows_len; x++) {
      ...
      page_len+=1;
      if ( page_len == 26 ) { page.innerHTML += header; page_len = 1; }
    }
   	
   	console.log(page_len)
   	console.table(data_fc._data)
